...
class ExamViewSet(viewsets.ModelViewSet):
    ...
    def unscheduled_exams(self, request):
        try:
            ...
            converted=map(lambda exam: {**exam, "group_id": [ UnscheduledExamGroupSerializer(UnscheduledExamGroup.objects.get(id=converted_group)) for converted_group in exam["group_id"]]}, serializer.data)
