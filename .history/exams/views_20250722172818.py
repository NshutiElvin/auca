            ...
            with transaction.atomic():
                ...
                for conf in conflicts:
                    ...
                    if conf[0] in new_groups:
                        g1= CourseGroupSerializer(CourseGroup.object.get(id=conf[0])).data
                        g2=CourseGroupSerializer(CourseGroup.object.get(id=conf[1])).data
                        conflict_matrix.append((g1, g2))
                    if conf[1] in new_groups:
                        g1= CourseGroupSerializer(CourseGroup.object.get(id=conf[1])).data
                        g2=CourseGroupSerializer(CourseGroup.object.get(id=conf[0])).data
                        conflict_matrix.append((g1, g2))
