...
class Exam(TimeStampedModel):
    ...
    timetable= models.ForeignKey(MasterTimetable, null=True, on_delete=models.CASCADE)
...
class MasterTimetableExam(models.Model):
    master_timetable = models.ForeignKey(MasterTimetable, on_delete=models.CASCADE)
    exam = models.ForeignKey(Exam, on_delete=models.CASCADE)

    class Meta:
        unique_together = ('master_timetable', 'exam')

    def __str__(self):
        return f"{self.master_timetable} -> {self.exam}"