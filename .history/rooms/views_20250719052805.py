...
#                 'exam__group__course__coursegroup__group_name',
...
#                 "course_group": item['exam__group__course__coursegroup__group_name']
...
class RoomViewSet(viewsets.ModelViewSet):
    ...
    def room_occupancies(self, request):
        ...
        student_exams = (
            ...
            .values(
                'room__id', 'room__name',"room__capacity",
                'exam__id', 'exam__course__code','exam__course__title','exam__course__department__name'
                'exam__date', 'exam__start_time', 'exam__end_time'
            )
            .annotate(student_count=Count('id'))
            .order_by('room__name', 'exam__date', 'exam__start_time')
        ...
        for item in student_exams:
            ...
            matching_schedule['exams'].append({
                ...
                "exam__department":item["exam__course__department__name"]
            })
