...
class RoomViewSet(viewsets.ModelViewSet):
        ...
        try:
            with transaction.atomic():
                ...
                current_room_occupancy = StudentExam.objects.filter(
                    ...
                    exam__start_time=exam_start_time
                ).count()
    ...
    def verify_room(self, request, *args, **kwargs):
        try:
            tz = pytz_timezone("Africa/Kigali")
            ...
            # If found, do something with student_exam
            print(f"Found exam: {student_exam}")
        except StudentExam.DoesNotExist:
            print("No matching exam found with status 'ready' or 'ongoing'")
