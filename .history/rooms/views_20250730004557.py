...
class RoomViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=['PATCH'], url_path='students')
    def students(self, request):
        try:
            print("Request data:", request.data)
            return Response({"success": False, "message": "This endpoint is not implemented yet"}, status=status.HTTP_200_OK)
