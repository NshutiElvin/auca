    ...
    def room_occupancies(self, request):
        ...
        student_exams = (
            ...
            .values(
                ...
                'exam__id', 'exam__coursegroup__course__code','exam__coursegroup__course__title',
                'exam__coursegroup__course__department__name',
                'exam__coursegroup__course__coursegroup__group_name',
                'exam__coursegroup__course__semester__name',
        ...
        for item in student_exams:
            ...
            matching_schedule['exams'].append({
                ...
                "course_code": item['exam__coursegroup__course__code'],
                "student_count": item['student_count'],
                "course_title":item['exam__coursegroup__course__title'],
                "course_department":item["exam__coursegroup__course__department__name"],
                "course_semester":item['exam__coursegroup__course__semester__name'],
                "course_group":item['exam__coursegroup__group_name']
            })
