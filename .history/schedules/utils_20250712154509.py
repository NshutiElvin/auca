...
def has_day_off(student_exam_dates):
    ...
    print(student_exam_dates)
    student_exam_dates= list(student_exam_dates)
    if len(student_exam_dates)<2:
        return True
    try:
        date1_str= student_exam_dates[-2]
        date2_str=student_exam_dates[-1]
            ...
            for date in sorted_dates:
                ...
                for course_id in pair:
                    ...
                    for student_id in student_ids:
                        if date in student_exam_dates[student_id] or not has_day_off(student_exam_dates[student_id]):
