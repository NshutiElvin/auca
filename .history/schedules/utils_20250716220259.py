...
def get_exam_slots(start_date, max_slots=None):
    ...
    end_date = start_date + timedelta(days=14)  # Limit to 14 days

    while (max_slots is None or len(date_slots) < max_slots) and current_date <= end_date:
...
def generate_exam_schedule(start_date=None, course_ids=None, semester=None):
    ...
    date_slots = get_exam_slots(start_date, max_slots=None)
