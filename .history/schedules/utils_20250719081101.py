...
def allocate_shared_rooms():
    ...
    with transaction.atomic():
        ...
        for date, slots in date_slot_students.items():
            for slot_name, slot_start, slot_end in SLOTS:
                ...
                while remaining_students and room_index < len(rooms):
                    ...
                    _ = schedule[date][slot_name][room.id]  # 🧠 Force initialization

                    if len(schedule[date][slot_name][room.id]) > 0:
                    ...
                    if assigned:
                        ...
                        break  # No more assignments possible in this room

                # After room loop: leftover students
        ...
        # Fallback round (try to squeeze unassigned into any available room)
        ...
        # Final list of students not accommodated
