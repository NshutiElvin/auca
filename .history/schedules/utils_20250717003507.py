...
def find_compatible_courses(course_conflict_matrix):
    ...
    while remaining_courses:
        # Pick the course with the MOST compatible remaining courses (not fewest!)
        course = max(
            remaining_courses,
        ...
        # Start a new group and add ALL compatible courses in one go
        group = {course}
        compatible_partners = compatibility_graph[course] & remaining_courses
        
        # Add every course that doesn't conflict with ANY course in the group
