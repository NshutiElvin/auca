...
def has_day_off(student_exam_dates):
    ...
    student_exam_dates= list(student_exam_dates)
...
def generate_exam_schedule(start_date=None, course_ids=None, semester=None):
    ...
    date_slots = get_exam_slots(start_date, max_slots=len(course_pairs) * 10)  
        ...
        for pair_idx, _ in pair_difficulties:
            ...
            for date in sorted_dates:
                ...
                for course_id in pair:
                    ...
                    for student_id in student_ids:
                        ...
                        if not has_day_off(student_exam_dates[student_id]):
                            all_dates=student_exam_dates[student_id]
                            new_date=all_dates [-1] + timedelta(days=2)
                            all_dates[-1]=new_date
                            student_exam_dates[student_id]=all_dates
                ...
                for slot_idx in slot_indices:
                    ...
                    if conflict_scores[pair_idx][slot_idx] < best_slot_score:
                        print( print(conflict_scores[pair_idx][slot_idx]), best_slot_score)
            ...
            for course_id in pair:
                ...
                for enrollment in students:
                    ...
                    student_exam_dates[enrollment.student_id].append(exam_date)
