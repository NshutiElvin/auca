...
def find_compatible_courses_within_group(courses):
    ...
    # # Include self-comparisons (always 0 conflicts)
    # for course in unique_courses:
    #     conflict_matrix[(course, course)] = 0
...
def generate_exam_schedule(start_date=None, end_date=None,course_ids=None, semester=None):
    ...
    try:
        ...
        conflict_matrix, conflict_matrix, conflict_graph = find_compatible_courses_within_group(courses) = find_compatible_courses_within_group(enrolled_courses)
