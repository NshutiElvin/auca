...
class ExamScheduler:
    ...
    def assign_rooms(self):
        ...
        for slot, exams in slot_exams.items():
            ...
            # Calculate student counts for each exam
            exam_students = []
            for exam in exams:
        ...
        for assignment in results['assignments']:
            for exam in assignment['exams']:
                StudentExam.objects.filter(exam=exam).update(room=assignment['room'])
