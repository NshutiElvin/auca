...
#     return True
def has_sufficient_gap(student_exam_dates, proposed_date, min_gap_days=2, max_gap_days=4):
    """
    Check if scheduling an exam on proposed_date would maintain a fair gap between exams
    """
    if not student_exam_dates:
        return True
...
def generate_exam_schedule(start_date=None, course_ids=None, semester=None):
    ...
    estimated_slots_needed = len(all_course_groups) * 20
