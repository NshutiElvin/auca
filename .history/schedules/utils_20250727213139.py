...
def get_student_exam(student_id, date, start_time, end_time):
    ...
    for student in enrolled_students_new_group:
        if suggested_slot == "Morning":
            ...
            if student in morning_students:
                conflicts['Morning'].append(f"Student {student} already has an  of  { } in the morning slot.")
        elif suggested_slot == "Afternoon" and student in slots_with_exams["Afternoon"]:
            print(f"Student {student} already has an exam in the afternoon slot.")
        elif suggested_slot == "Evening" and student in slots_with_exams["Evening"]:
            print(f"Student {student} already has an exam in the evening slot.")
        else:
            print(f"Student {student} can take the exam in the {suggested_slot} slot.")

    print(enrolled_students)
    print(all_Students_enrolled_for_to_days_exams)
