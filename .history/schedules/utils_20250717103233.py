        ...
        for group_idx, course_group in enumerate(compatible_groups):
            ...
            for date in sorted(slots_by_date.keys()):
                ...
                for course_id in course_group:
                    ...
                    # Determine slot based on preference
                ...
                if len(group_exams) == len(course_group):
                    try:
                        ...
                        break  # Group successfully scheduled — stop trying other dates
                    except Exception as e:
                        print(f"Room allocation error for group {group_idx}: {e}")
                        # Rollback created exams if room allocation failed
