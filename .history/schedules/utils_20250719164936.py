...
def generate_exam_schedule(start_date=None, end_date=None,course_ids=None, semester=None):
    ...
    try:
        ...
        scheduled_groups= compatible_groups
        ...
        pprint(len(sorted(slots_by_date.keys())), len(compatible_groups))
                ...
                for mycourse_group in courses:
                    ...
                    for group_id in course_groups:
                        ...
                        try:
                            ...
                            break
                date_index+=1
                scheduled_groups.pop(idx)
                 
            
        unaccommodated_students=allocate_shared_rooms()
        return exams_created, unaccommodated_students, scheduled_groups
