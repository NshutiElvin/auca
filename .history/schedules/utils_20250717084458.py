...
def generate_exam_schedule(start_date=None, course_ids=None, semester=None):
    ...
    # Generate enough slots
    estimated_slots_needed = len(compatible_groups) * 5
    date_slots = get_exam_slots(start_date, max_slots=estimated_slots_needed)
...
#         # Track which groups have been scheduled
#         scheduled_groups = set()
...
#             if weekday=="Saturday":
#                 continue
#             available_slots = [  ('Morning', time(8, 0), time(11, 0)),
#                         ('Afternoon', time(13, 0), time(16, 0)),
#                         ('Evening', time(17, 0), time(20, 0)),]
#             if weekday == 'Friday':
#                 # Only morning and afternoon available on Friday
...
#                         if course_preference=="A" or course_preference=="B":
#                             start_time=time(8, 0)
#                             end_time=time(11, 0)
#                             slot="Morning"
#                         elif course_preference=="C" or course_preference=="D":
#                             guess=  random.randint(1,3)
#                             if guess==1:
#                                 start_time=time(8, 0)
#                                 end_time=time(11, 0)
...
#                         elif course_preference=="E" or course_preference=="F":
#                             if weekday !="Friday":
#                                 start_time=time(18, 0)
#                                 end_time=time(20, 0)
#                                 slot="Evening" 
...
#                         try:
#                             unaccommodated = allocate_shared_rooms(group_exams)
#                             print(f"  ✓ Scheduled {group_exams} ")
#                             if unaccommodated:
#                                 print(f"    Warning: {len(unaccommodated)} students unaccommodated")
#                         except Exception as e:
#                             print(f"    Room allocation error: {e}")
                        
#                         any_group_scheduled_today = True
#                         break  # Move to next group after scheduling this one
                    
#                     # If this group was scheduled, move to next group
#                     if group_idx in scheduled_groups:
#                         break
                
#                 # If no group was scheduled in this iteration, move to next date
#                 if not any_group_scheduled_today:
#                     break
