...
def allocate_shared_rooms(exams):
    ...
    # Allocate rooms to exam groups
    for group_idx, exam_group in enumerate(exam_groups):
        if group_idx >= len(rooms):
            # No more rooms available, add students to unaccommodated list
        ...
        for exam in exam_group:
            ...
            # Add unallocated students to unaccommodated list
            unaccommodated_students.extend([s.student for s in unallocated_students])
