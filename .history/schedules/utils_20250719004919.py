...
def get_exam_slots(start_date,end_date, max_slots=None):
    ...
    while current_date <= end_date and max_slots is None or len(date_slots) < max_slots:
...
def generate_exam_schedule(start_date=None, end_date=None,course_ids=None, semester=None):
    ...
    try:
        ...
        compatible_groups, conflict_graph= find_compatible_courses_within_group(enrolled_courses)
